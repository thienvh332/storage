...
--- | --- | --- | ---
[fs_attachment](fs_attachment/) | 16.0.1.0.15 | [![lmignon](https://github.com/lmignon.png?size=30px)](https://github.com/lmignon) | Store attachments on external object store
...
[storage_backend](storage_backend/) | 16.0.1.0.2 |  | Implement the concept of Storage with amazon S3, sftp...
